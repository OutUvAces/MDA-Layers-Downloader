...
# Test that multi-feature warnings still work correctly
...
print("Testing multi-feature warning:")
print("=" * 60)
print(multi_warning)
print("=" * 60)
print()
...
for i, coord_set in enumerate(coord_sets):
    ...
    if len(coord_set) >= 3:
        print(f"  Feature text: {repr(coord_set[2][:60])}...")
print()

if coord_sets:
    print("Testing feature descriptions for each area:")
    for i, coord_set in enumerate(coord_sets):
